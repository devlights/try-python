...
def make_mappings() -> Dict[str, Callable]:
    # noinspection PyDictCreation
    m = {}

    # trypython.advanced
    _register_advanced_modules(m)

    # trypython.basic
    _register_basic_modules(m)

    # trypython.extlib
    _register_extlib_modules(m)

    # trypython.stdlib
    _register_stdlib_modules(m)

    # trypython.py38
    _register_py38_modules(m)

    return m


def _register_advanced_modules(m: Dict[str, Callable]):
    ########################################
    # trypython.advenced
    ########################################
...
def _register_basic_modules(m: Dict[str, Callable]):
    ########################################
    # trypython.basic
    ########################################
    pass
...
def _register_extlib_modules(m: Dict[str, Callable]):
    ########################################
    # trypython.extlib
    ########################################
    pass
...
def _register_stdlib_modules(m: Dict[str, Callable]):
    ########################################
    # trypython.stdlib
    ########################################
    pass
...
def _register_py38_modules(m: Dict[str, Callable]):
    ########################################
    # trypython.py38
    ########################################
    pass
